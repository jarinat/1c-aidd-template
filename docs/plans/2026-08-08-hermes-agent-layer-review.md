...
- [x] **Step 1: Сверка с итерацией A** (A устарела; забрать examples, миграцию, README-секцию)
...
- [x] **Step 2: Секция 10 — вход для самоулучшения**
...
- [x] **Step 4: Задать пользователю батч вопросов** (4 решения получены и вписаны)
