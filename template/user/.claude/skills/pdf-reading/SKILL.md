...
use the environment's general PDF manipulation skill instead of this one.
...
other PDF manipulation tasks, use the environment's general PDF
manipulation skill instead of this one.
