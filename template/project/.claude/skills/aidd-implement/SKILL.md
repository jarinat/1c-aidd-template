...
8. После каждой задачи проверь результат и отсутствие выхода за scope.
   ...
   наблюдение относится к companion, до fallback или следующей задачи зафиксируй
...
10. Сразу после успешного commit блока или успешной verification-only проверки
   ...
   A-COMP добавь ссылку на каноническую запись research или PRD, а не дублируй
   evidence.
