...
- Построить трассировку каждого `FR` и `AC` из PRD на блок/задачи и конкретную
  проверку или DoD. Если требование не покрыто и нет явного решения об отсрочке
  или неприменимости, вернуть blocker вместо готового tasklist.
...
- таблица трассировки `FR/AC | Блок/задачи | Проверка/DoD | Статус/источник`
